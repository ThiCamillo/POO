...
public class Cozinha {
	...
	public static void main(String[] args) {
		...
		double consumoMensal = g1.calcularConsumo() 
				+ f1.calcularConsumo() 
				+ m1.calcularConsumo()
				+ ll1.calcularConsumo() 
				+ fe1.calcularConsumo();
		...
		double consumoPeriodo = g1.calcularConsumo(10)
				+ f1.calcularConsumo(10)
				+ m1.calcularConsumo(10)
				+ ll1.calcularConsumo(10)
				+ fe1.calcularConsumo(10);
