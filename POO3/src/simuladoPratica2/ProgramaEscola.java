...
public class ProgramaEscola {
	...
	public static void main(String[] args) {
		...
		Aluno Renata = new Aluno("Renata Silva", 15, endRenata);
		...
		Professor p2 = new Professor("Pires", 40, endP2, "Português");
		...
		Endereco endEscola = new Endereco("Rua dos Estudos", 1000, "Centro", "Florianopolis", "Santa Catarina");
